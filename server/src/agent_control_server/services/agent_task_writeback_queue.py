...
class WritebackQueueService:
    ...
    async def deliver_comment(
        ...
        *,
        ...
        await attach_step_files(
            self._db, self._runtime, row=row, task=task, agent_name=agent_name
        )
